...
const VerifyEmail = () => {
    ...
    const handleResend = async () => {
        ...
        try {
            const { data } = await axios.post('/api/auth/resendVerificationEmail', { email: storedEmail }, {
                withCredentials: true,
            });
        ...
        <>
            <div className="flex justify-center items-center min-h-dvh bg-gray-100">
                <div className="flex w-full min-h-dvh overflow-hidden shadow-2xl bg-white">
                    ...
                    {/* Left Panel */}
                    <div
                        className="sm:w-[50%] hidden relative sm:flex flex-col justify-between p-9 overflow-hidden"
